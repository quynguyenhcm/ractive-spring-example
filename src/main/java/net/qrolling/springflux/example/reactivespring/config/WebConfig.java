package net.qrolling.springflux.example.reactivespring.config;

import net.qrolling.springflux.example.reactivespring.controller.PurchaseHandler;
...
public class WebConfig implements WebFluxConfigurer {
    ...
    public RouterFunction<ServerResponse> routerFunctionAllPurchases(final PurchaseHandler purchaseHandler){
        return RouterFunctions
                .route(
                        RequestPredicates.GET("/coin/purchase/v1/"), purchaseHandler::listAllPurchases);
    }
}
